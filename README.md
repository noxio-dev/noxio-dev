<div align="center">
  <h1>Hi, I'm NoxioDev 👋</h1>
  <h3>Fullstack Developer | From Low-Level Systems to High-Level Architecture</h3>
</div>
...
I'm a French fullstack developer navigating between **low-level programming** (memory management, system performance, architecture) and **high-level development** (APIs, backend services, full application architecture).
...
![Make](https://img.shields.io/badge/Make-A42E2B?style=flat&logo=gnu&logoColor=white)
